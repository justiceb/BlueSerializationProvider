...
<Library LVVersion="19008000">
	...
	<Item Name="Autosize Listbox Columns (Uniform Text).vi" Type="VI" URL="../Autosize Listbox Columns (Uniform Text).vi"/>
	<Item Name="MutationHistoryGUI.vi" Type="VI" URL="../MutationHistoryGUI.vi"/>
	<Item Name="MutationHistoryToTable.vi" Type="VI" URL="../MutationHistoryToTable.vi"/>
	<Item Name="ReadMutationHistory.vi" Type="VI" URL="../ReadMutationHistory.vi"/>
</Library>
